package org.apache.nutch.parse.d51cto;
...
public class D51CTOHtmlParser implements HtmlParseFilter {

	public static final Logger logger = LoggerFactory.getLogger(D51CTOHtmlParser.class);
	...
	public void setConf(Configuration conf) {
		...
		if (conf != null) {
			...
			baseUrl = conf.get("d51cto.url", null);
			contentClass = conf.get("d51cto.content.class", null);
		} else {
	...
	//	FileSystem fs = FileSystem.getLocal(conf);
		...
		D51CTOHtmlParser htmlParser = new D51CTOHtmlParser();
